...
void craft_window_load(Window *window)
{
  ...
  scroll_layer_add_child(scroll, bitmap_layer_get_layer(crafting_table));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(a1));
	...
	scroll_layer_add_child(scroll,  text_layer_get_layer(b1));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(c1));
    ...
    text_layer_set_text(a2, craft_recipe.simple_table[3]);
	 scroll_layer_add_child(scroll, text_layer_get_layer(a2));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(b2));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(c2));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(a3));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(b3));
	...
	scroll_layer_add_child(scroll, text_layer_get_layer(c3));
	...
	snprintf(buffer, sizeof(buffer), "%s: %s\n%s: %s\n%s: %s\n%s: %s\n%s: %s\n%s: %s\n%s: %s\n%s: %s\n%s: %s", craft_recipe.simple_table[0], craft_recipe.advanced_table[0],  craft_recipe.simple_table[1], craft_recipe.advanced_table[1], craft_recipe.simple_table[2], craft_recipe.advanced_table[2], craft_recipe.simple_table[3], craft_recipe.advanced_table[3], craft_recipe.simple_table[4], craft_recipe.advanced_table[4], craft_recipe.simple_table[5], craft_recipe.advanced_table[5], craft_recipe.simple_table[6], craft_recipe.advanced_table[6], craft_recipe.simple_table[7], craft_recipe.advanced_table[7], craft_recipe.simple_table[8], craft_recipe.advanced_table[8]);
	scroll_layer_add_child(scroll, text_layer_get_layer(key));
	text_layer_set_text(key, buffer);
	text_layer_set_text_alignment(key, GTextAlignmentCenter);
	
	scroll_layer_set_content_size(scroll, GSize(144, 300));
